...
export const orderApi = privateAPi.injectEndpoints({
  endpoints: (build) => ({
    ...
    payOrder: build.mutation({
      query: ({ orderId, paymentMethod }) => ({ url: `/restaurants/orders/${orderId}/pay/`, method: "POST", body: { payment_method: paymentMethod || "cash" } }),
    ...
    receiveCashPayment: build.mutation({
      ...
      invalidatesTags: ["PendingOrders", "getOrders", "getOrder"],
    }),
    settleCashPayment: build.mutation({
      query: (orderId) => ({ url: `/restaurants/orders/${orderId}/cash-settle/`, method: "POST" }),
      invalidatesTags: ["PendingOrders", "getOrders", "getOrder", "ManagerDashboard"],
    }),
    ...
    acceptOrder: build.mutation({ query: (orderId) => ({ url: `/restaurants/orders/${orderId}/accept/`, method: "POST" }), invalidatesTags: ["PendingOrders", "getOrders"] }),
    assignChef: build.mutation({ query: ({ orderId, chefId }) => ({ url: `/restaurants/orders/${orderId}/assign-chef/`, method: "POST", body: { chef_id: chefId } }), invalidatesTags: ["PendingOrders", "getOrders"] }),
    ...
    markPrepared: build.mutation({ query: (orderId) => ({ url: `/restaurants/orders/${orderId}/mark-prepared/`, method: "POST" }), invalidatesTags: ["ChefOrders"] }),
...
export const {
  ...
  useRequestCashPaymentMutation, useReceiveCashPaymentMutation, useSettleCashPaymentMutation,
