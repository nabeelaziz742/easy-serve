...
export const orderApi = privateAPi.injectEndpoints({
  endpoints: (build) => ({
    ...
    getManagerCashOrders: build.query({
      ...
      providesTags: ["ManagerCashOrders"],
      ...liveRefresh("ManagerCashOrders", 3000),
    }),
    ...
    getPendingOrders: build.query({
      ...
      ...liveRefresh("PendingOrders", 3000),
    }),
    getReadyOrders: build.query({
      query: () => ({ url: "/restaurants/orders/ready/", method: "GET" }),
      providesTags: ["ReadyOrders"],
      ...liveRefresh("ReadyOrders", 3000),
    }),
    ...
    getManagerDashboard: build.query({
      ...
      ...liveRefresh("ManagerDashboard", 3000),
    }),
  }),
});
